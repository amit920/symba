...
class addInternProfileImagePopUpForm extends React.Component {
  constructor(props) {
    super(props);
...
addInternProfileImagePopUpForm = reduxForm({
  form: "addInternProfileImagePopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(addInternProfileImagePopUpForm);

const selector = formValueSelector("addInternProfileImagePopUpForm"); // <-- same as form name

...
class InternInterestsPopupForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedInterests: [],
...
InternInterestsPopupForm = reduxForm({
  form: "InternInterestsPopupForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(InternInterestsPopupForm);

const selector = formValueSelector("InternInterestsPopupForm"); // <-- same as form name

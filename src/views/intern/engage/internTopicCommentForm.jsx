...
import { Intern_Delete_Topic } from "../../../action/engage/engage";
import EditTopicPopUpForm from "../engage/editinternTopicPopUpForm";
import EditCommentPopUpForm from "../engage/editinternCommentPopUpForm";
...
class internTopicCommentForm extends Component {
  constructor(props) {
    super(props);
  ...
  handleRemoveTopic = (topicid) => {
    this.props.Intern_Delete_Topic(topicid);
  };
  handleReply = (index) => {
  ...
  componentDidMount() {
    if (this.props.topicId != null) {
      ...
      // this.props.getUserTopicReactions(filterObj);
    }
  ...
  closeTopicSubmissionModal = () => {
    this.props.dispatch(reset("editinternTopicPopUpForm"));
          ...
          <Fragment>
            <Row>
              <Colxx xxs="2" lg="2" md="2">
                <Link to={"/internapp/engage/view/" + 2}>
                  <i
...
internTopicCommentForm = reduxForm({
  form: "internTopicCommentForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(internTopicCommentForm);

//const selector = formValueSelector("internTopicCommentForm"); // <-- same as form name
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    Intern_Delete_Topic: (topicid) => {
      dispatch(Intern_Delete_Topic(topicid));
    },
    dispatch: dispatch,
  };
};

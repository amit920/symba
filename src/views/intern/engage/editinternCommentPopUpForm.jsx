...
class editinternCommentPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
editinternCommentPopUpForm = reduxForm({
  form: "editinternCommentPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editinternCommentPopUpForm);
const selector = formValueSelector("editinternCommentPopUpForm"); // <-- same as form name

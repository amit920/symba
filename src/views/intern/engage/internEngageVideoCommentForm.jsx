...
class internEngageVideoCommentForm extends Component {
  constructor(props) {
    super(props);
  ...
  getEngageVideo = () => {
    ...
    if (this.props.engageVideoDetail) {
      ...
      if (this.props.engageVideoDetail.EngageVideoUrl != null) {
        Row.push(
          <div className="internEngagevideo_rplayer_learningcenter">
            {
              <ReactPlayer
...
internEngageVideoCommentForm = reduxForm({
  form: "internEngageVideoCommentForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(internEngageVideoCommentForm);

// const selector = formValueSelector("internEngageVideoCommentForm"); // <-- same as form name

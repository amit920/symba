...
import InternTopicCommentForm from "../../../views/intern/engage/internTopicCommentForm";

import { AddTopicComment } from "../../../action/engage/engage";
// import { NotificationManager } from "../../../components/common/react-notifications";
class addInternTopicCommentForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      formError: [],
...
export default connect(mapStateToProps, mapDispatchToProps)(addInternTopicCommentForm);

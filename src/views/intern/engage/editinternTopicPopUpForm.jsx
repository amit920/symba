...
//   height: "200px",
// };
class editinternTopicPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      chars_left: 500,
...
editinternTopicPopUpForm = reduxForm({
  form: "editinternTopicPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editinternTopicPopUpForm);
const selector = formValueSelector("editinternTopicPopUpForm"); // <-- same as form name

...
class InternLaunchpad extends Component {
  constructor(props) {
    super(props);
    ...
    if (this.props.LaunchpadDetail) {
      ...
      if (this.props.LaunchpadDetail.videourl != null) {
        if (
          ...
          Row.push(
            // <div className="internplayer-wrapper">
            <div>
              {
                <ReactPlayer
                  url={this.props.LaunchpadDetail.videourl}
                  controls={true}
                  className="internreact-player"
                  fluid={false}
                  width="{100%}"
                  height="{100%}"
                />
  ...
  render() {
    return (
      ...
      //   </Row>
      //   <Row>
      //     <Colxx xxs="12" lg="10" sm="12" md="10" xl="10">
      ...
      <Fragment>
        ...
        <Row>
          {/* <Colxx xxs="12" sm="12" md="10" lg="10"  xl="10"> */}
          <Colxx xxs="12" lg="12" xl="12">
            <div style={{ textAlign: "center" }}>
              <span
                style={{
...
export default connect(mapStateToProps, mapDispatchToProps)(InternLaunchpad);

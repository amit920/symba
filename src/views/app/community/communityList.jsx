            ...
            <Colxx xxs="12" sm="6" md="6" lg="4" xl="3">
              {
                ...
                >
                  <CardBody className=" community_cardsbody">
                    <div className="text-center">
                      {image}
                      <br />
                      {/* <CardImg top src="/assets/img/profile-pic-l.jpg" alt="Card image cap" className="img-thumbnail border-0 rounded-circle mb-3 list-thumbnail" /> */}
                      <Link
                        to={
                          "/app/community/view/" +
    ...
    return (
      <Fragment>
        ...
        <Row>
          ...
          >
            <span style={{ fontSize: "17px" }} className="alone-we-can-do-so">

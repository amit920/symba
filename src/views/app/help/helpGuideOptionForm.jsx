        ...
        <Fragment>
          ...
          <Row>
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/app/symba/help-center/guide/1/Launchpad"}>
            ...
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/app/symba/help-center/guide/1/Engage"}>
                <Card className="help_card">
                  <CardBody className="text-center">
            ...
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/app/symba/help-center/guide/1/Projects"}>
                <Card className="help_card">
                  <CardBody className="text-center">
            ...
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/app/symba/help-center/guide/1/Community"}>
                <Card className="help_card">
                  <CardBody className="text-center">
            ...
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/app/symba/help-center/guide/1/Feedback"}>
                <Card className="help_card">
                  <CardBody className="text-center">
            ...
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/app/symba/help-center/guide/1/Dashboard"}>
                <Card className="help_card">
                  <CardBody className="text-center">
                    <i className="glyph-icon simple-icon-speedometer help_community_icon" />
                    <br></br>
                    <br></br>
                    <div className="help_community">
                      <p className="card-text font-weight-semibold mb-0 help_community_card_title">
                      ...
                      <br></br>
                      <p className="text-center help_center">
                        View program analytics and insights to ensure success
                      </p>
                    </div>
                  </CardBody>
                </Card>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    // addHelpDetails: (params, callback) => {dispatch(addHelpDetails(params, callback))},

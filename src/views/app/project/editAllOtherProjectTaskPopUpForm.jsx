...
class editAllOtherProjectTaskPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    // let rows = [];
    this.state = {};
...
editAllOtherProjectTaskPopUpForm = reduxForm({
  form: "editAllOtherProjectTaskPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editAllOtherProjectTaskPopUpForm);

const selector = formValueSelector("editAllOtherProjectTaskPopUpForm"); // <-- same as form name

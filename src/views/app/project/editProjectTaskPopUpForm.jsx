...
class editProjectTaskPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    // let rows = [];
    this.state = {
...
editProjectTaskPopUpForm = reduxForm({
  form: "editProjectTaskPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editProjectTaskPopUpForm);

const selector = formValueSelector("editProjectTaskPopUpForm"); // <-- same as form name

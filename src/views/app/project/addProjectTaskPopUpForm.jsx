...
class addProjectTaskPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      chars_left: 100,
        ...
        <div>
          <form onSubmit={handleSubmit}  autocomplete="off">
            <ModalHeader>
              <h2>
                Add Task <br />
                <h6>Please include the Task and Due Date below.</h6>
              </h2>
            </ModalHeader>
...
addProjectTaskPopUpForm = reduxForm({
  form: "addProjectTaskPopUpForm",
  validate: (values) => {
    return validate(values, validations);
  },
})(addProjectTaskPopUpForm);

const selector = formValueSelector("addProjectTaskPopUpForm"); // <-- same as form name

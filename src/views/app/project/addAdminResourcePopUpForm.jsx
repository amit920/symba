...
class addAdminResourcePopUpForm extends React.Component {
  constructor(props) {
    super(props);
    // let rows = [];
    this.state = {
...
addAdminResourcePopUpForm = reduxForm({
  form: "addAdminResourcePopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(addAdminResourcePopUpForm);

const selector = formValueSelector("addAdminResourcePopUpForm"); // <-- same as form name

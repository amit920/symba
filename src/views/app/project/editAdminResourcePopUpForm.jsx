...
class editAdminResourcePopUpForm extends React.Component {
  constructor(props) {
    super(props);
    // let rows = [];
    this.state = {
...
editAdminResourcePopUpForm = reduxForm({
  form: "editAdminResourcePopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editAdminResourcePopUpForm);

const selector = formValueSelector("editAdminResourcePopUpForm"); // <-- same as form name

...
class addAllOtherProjectTaskPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
addAllOtherProjectTaskPopUpForm = reduxForm({
  form: "addAllOtherProjectTaskPopUpForm",
  validate: (values) => {
    return validate(values, validations);
  },
})(addAllOtherProjectTaskPopUpForm);

const selector = formValueSelector("addAllOtherProjectTaskPopUpForm"); // <-- same as form name

...
class addAllOtherResourcePopUpForm extends React.Component {
  constructor(props) {
    super(props);
    // let rows = [];
    this.state = {
...
addAllOtherResourcePopUpForm = reduxForm({
  form: "addAllOtherResourcePopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(addAllOtherResourcePopUpForm);

const selector = formValueSelector("addAllOtherResourcePopUpForm"); // <-- same as form name

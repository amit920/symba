...
class editCommentPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
          ...
          <form onSubmit={handleSubmit}>
            ...
            <ModalBody>
              <div className="container-fluid">
                <Row>
                  <Colxx className="commentmargin" xxs="12" sm="12" md="12">
...
editCommentPopUpForm = reduxForm({
  form: "editCommentPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editCommentPopUpForm);
const selector = formValueSelector("editCommentPopUpForm"); // <-- same as form name

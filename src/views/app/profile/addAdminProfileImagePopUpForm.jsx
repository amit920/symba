...
import { addAdminProfileImage } from "../../../action/profile/profile";

class addAdminProfileImagePopUpForm extends React.Component {
  constructor(props) {
    super(props);
  ...
  SubmitAdminProfileCroppingImageClick = () => {
    ...
    this.props.addAdminProfileImage(params);
  };
  handelInitialValues = () => {
...
addAdminProfileImagePopUpForm = reduxForm({
  form: "addAdminProfileImagePopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(addAdminProfileImagePopUpForm);

const selector = formValueSelector("addAdminProfileImagePopUpForm"); // <-- same as form name
...
const mapDispatchToProps = (dispatch) => ({
  addAdminProfileImage: (params, callback) => {
    dispatch(addAdminProfileImage(params, callback));
  },
});

...
class AdminInterestsPopupForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedInterests: [],
...
AdminInterestsPopupForm = reduxForm({
  form: "AdminInterestsPopupForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(AdminInterestsPopupForm);

const selector = formValueSelector("AdminInterestsPopupForm"); // <-- same as form name

...
class AdminSkillsPopupForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedSkills: [],
...
AdminSkillsPopupForm = reduxForm({
  form: "AdminSkillsPopupForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(AdminSkillsPopupForm);

const selector = formValueSelector("AdminSkillsPopupForm"); // <-- same as form name

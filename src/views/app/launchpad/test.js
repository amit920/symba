...
class AdminLaunchpad extends Component {
  ...
  toggleTab(tab, dept) {
    ...
    if (
      ...
      this.setState({
        ResourcesHeading:
          "Here is where we link to everything  you will need over the course of the fall.",
      });
    } else {
      this.setState({
        ResourcesHeading:
          "Here is where we link to everything  you will need over the course of the program.",
      });
    }
  }
  componentDidMount() {
  ...
  getOrgVideo = () => {
    ...
    if (this.props.LaunchpadDetail) {
      ...
      Container.push(<div style={{ marginLeft: "55px" }}>{Row}</div>);
  ...
  getOrgDescription = () => {
    ...
    if (this.props.LaunchpadDetail) {
      ...
      if (this.props.LaunchpadDetail.overviewDescription != null) {
        Row.push(
          <div>
            {<label>{this.props.LaunchpadDetail.overviewDescription}</label>}
          </div>
        );
      } else {
        Row.push(<div>{}</div>);
          ...
          <Colxx xxs="12">
            ...
            <TabContent activeTab={this.state.activeTab}>
              <TabPane tabId={0}>
                ...
                <Row>
                  <Colxx xxs="12" lg="1" xl="1"></Colxx>
                  <Colxx xxs="12" lg="8" xl="8" style={{ textAlign: "center" }}>
                    <h2 style={{ fontWeight: "bold" }}> Resources</h2>
                    <label
                      style={{
                        fontSize: "16px",
                        height: "43px",

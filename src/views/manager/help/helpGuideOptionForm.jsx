        ...
        <Fragment>
          ...
          <Row>
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/managerapp/symba/help-center/guide/2/Launchpad"}>
            ...
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/managerapp/symba/help-center/guide/2/Engage"}>
                <Card className="help_card">
                  <CardBody className="text-center">
            ...
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/managerapp/symba/help-center/guide/2/Projects"}>
                <Card className="help_card">
                  <CardBody className="text-center">
            ...
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/managerapp/symba/help-center/guide/2/Community"}>
                <Card className="help_card">
                  <CardBody className="text-center">
            ...
            <Colxx md="6" sm="6" lg="4" xxs="12">
              <Link to={"/managerapp/symba/help-center/guide/2/Feedback"}>
                <Card className="help_card">
                  <CardBody className="text-center">

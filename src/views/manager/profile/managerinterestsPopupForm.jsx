...
class ManagerInterestsPopupForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedInterests: [],
          ...
          <form onSubmit={handleSubmit}>
            ...
            <ModalFooter>
              ...
              <Button
                color="primary"
                type="submit"
                // onClick={this.props.data(this.state.counter2)}
...
ManagerInterestsPopupForm = reduxForm({
  form: "ManagerInterestsPopupForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(ManagerInterestsPopupForm);

const selector = formValueSelector("ManagerInterestsPopupForm"); // <-- same as form name

...
class ManagerSkillsPopupForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedSkills: [],
...
ManagerSkillsPopupForm = reduxForm({
  form: "ManagerSkillsPopupForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(ManagerSkillsPopupForm);

const selector = formValueSelector("ManagerSkillsPopupForm"); // <-- same as form name

...
//   height: "200px",
// };
class addManagerTopicPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      chars_left: 500,
...
addManagerTopicPopUpForm = reduxForm({
  form: "addManagerTopicPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(addManagerTopicPopUpForm);

const selector = formValueSelector("addManagerTopicPopUpForm"); // <-- same as form name

...
//   height: "200px",
// };
class editmanagerTopicPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      chars_left: 500,
...
editmanagerTopicPopUpForm = reduxForm({
  form: "editmanagerTopicPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editmanagerTopicPopUpForm);
const selector = formValueSelector("editmanagerTopicPopUpForm"); // <-- same as form name

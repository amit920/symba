...
import AddManagerTopicPopUpForm from "./addManagerTopicPopUpForm";
...
/* eslint-disable */
class ManagerEngageList extends Component {
  constructor(props) {
    super(props);
  ...
  closeTopicSubmissionModal = () => {
    this.props.dispatch(reset("addManagerTopicPopUpForm"));
    this.setState({ addTopicModal: false });
  };
  // submitUpdate = values => {
  //   values.createby = this.props.currentUser.UserId
  //   // values.departmentid=this.props.deptId
  //   this.props.updateEngageVideodetail(this.props.currentUser.organization.id, values, this.closeEditSubmissionModal);
  // }
  // getTopic = (topic) => {
  //   this.setState({
  //     topictext: topic,
  ...
  submitTopic = (values) => {
    ...
    this.props.addManagerDiscussionTopic(
      values,
                  ...
                  <Colxx xxs="10" sm="10" md="10" lg="10" xl="10  ">
                    {
                      <div>
                        ...
                        >
                          <Link
                            to={
                              "/managerapp/engage/topic/comment/" +
                              topic.Topicid
                            }
                          >
                            <CardTitle
  ...
  render() {
    return (
      <div>
        ...
        {/* <EditEngageVideoPopUpForm onSubmit={this.submitUpdate} dispatch={this.props.dispatch} onRequestClose={this.closeEditSubmissionModal} modalStatus={this.state.editEngageVideoModal} currentUser={this.props.currentUser}   engageVideoData={this.state.currentEngageData} /> */}
        <AddManagerTopicPopUpForm
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    addManagerDiscussionTopic: (params, callback) => {
      dispatch(addManagerDiscussionTopic(params, callback));
    },
    // getCategoryList: (organization) => { dispatch(getCategoryList(organization)) },
...
export default connect(mapStateToProps, mapDispatchToProps)(ManagerEngageList);

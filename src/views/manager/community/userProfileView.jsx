      ...
      <Fragment>
        <Row>
          <Colxx xxs="5" lg="5" md="5">
            <div onClick={browserHistory.goBack} style={{ cursor: "pointer" }}>
              <i
        ...
        <Row>
          {/* <Colxx xxs="12" md="4"sm="12" lg="3"
            ...
            > */}
          <Colxx xxs="12" md="4" sm="12" lg="3" style={{ textAlign: "center" }}>
          ...
          <Colxx xxs="12" md="8" sm="12" lg="6">
            ...
            <div style={{ marginBottom: 160 }}>
              ...
              {this.props.userDetail.QuesResponseCount > 0 ? (
                this.props.userDetail.QuestionResponse.map((Question, key) => {
                  return (
                    <div
                      className="QuesDiv"
                      style={{

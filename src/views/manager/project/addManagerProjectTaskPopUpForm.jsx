...
class addManagerProjectTaskPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
addManagerProjectTaskPopUpForm = reduxForm({
  form: "addManagerProjectTaskPopUpForm",
  validate: (values) => {
    return validate(values, validations);
  },
})(addManagerProjectTaskPopUpForm);

const selector = formValueSelector("addManagerProjectTaskPopUpForm"); // <-- same as form name

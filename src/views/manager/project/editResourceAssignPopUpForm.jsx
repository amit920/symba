...
class editResourcesAssignPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    // let rows = [];
    this.state = {};
...
editResourcesAssignPopUpForm = reduxForm({
  form: "editResourcesAssignPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editResourcesAssignPopUpForm);

const selector = formValueSelector("editResourcesAssignPopUpForm"); // <-- same as form name

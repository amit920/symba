...
class resourcesAssignPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    // let rows = [];
    this.state = {
...
resourcesAssignPopUpForm = reduxForm({
  form: "resourcesAssignPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(resourcesAssignPopUpForm);

const selector = formValueSelector("resourcesAssignPopUpForm"); // <-- same as form name

...
import { Alumni_Delete_Topic } from "../../../action/engage/engage";

import EditTopicPopUpForm from "../engage/editalumniTopicPopUpForm";
import EditCommentPopUpForm from "../engage/editalumniCommentPopUpForm";
...
class alumniTopicCommentForm extends Component {
  constructor(props) {
    super(props);
  ...
  closeTopicSubmissionModal = () => {
    this.props.dispatch(reset("editalumniTopicPopUpForm"));
  ...
  handleRemoveTopic = (topicid) => {
    this.props.Alumni_Delete_Topic(topicid);
  };
          ...
          <div>
            {
              ...
              >
                <div class="row">
                  ...
                  {/* <Colxx xxs="12" sm="12" md="12" lg="12" xl="12" style={{ minHeight: "110px" }}>
                    <div style={{ marginTop: "10px" }}>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: this.props.topicDetail.Topictext,
    ...
    if (this.props.topicCommentList) {
      if (this.props.topicCommentCount > 0) {
        ...
        for (let i = 0; i < this.props.topicCommentCount; i++) {
          Title.push(
            <Colxx xxs="12" md="9" sm="12" lg="9" xl="9">
              {
                <div>
                  {/* <Card>
          ...
          <Fragment>
            <Row>
              <Colxx xxs="2" lg="2" md="2">
                <Link to={"/alumniapp/engage/view/" + 2}>
                  <i
...
alumniTopicCommentForm = reduxForm({
  form: "alumniTopicCommentForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(alumniTopicCommentForm);

//const selector = formValueSelector("alumniTopicCommentForm"); // <-- same as form name
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    Alumni_Delete_Topic: (topicid) => {
      dispatch(Alumni_Delete_Topic(topicid));
    },
    dispatch: dispatch,
  };
};

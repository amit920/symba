...
class alumniEngageVideoCommentForm extends Component {
  constructor(props) {
    super(props);
  ...
  //     this.props.getEngageVideoDetails(this.props.EngageVideoId);
  //   }
  ...
  getEngageVideo = () => {
    ...
    if (this.props.engageVideoDetail) {
      ...
      if (this.props.engageVideoDetail.EngageVideoUrl != null) {
        Row.push(
          <div className="alumniEngagevideo_rplayer_learningcenter">
            {
              <ReactPlayer
          ...
          <Fragment>
            ...
            <Row>
              <Colxx xxs="3" md="1" lg="1" sm="1">
                ...
                {/* <img style={{borderRadius:'0.1rem',width:'100%'}} src={this.props.currentUser.ProfileImage}></img> */}
              </Colxx>
              ...
              <Colxx xxs="12" md="3" lg="3" sm="3">
                <div style={{ marginTop: "15px", float: "right" }}>
                  ...
                  {/* <Link style={{color:'rgb(30, 186, 214)',fontWeight:'bold',fontSize:'17px',marginTop:'13px'}}
...
alumniEngageVideoCommentForm = reduxForm({
  form: "alumniEngageVideoCommentForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(alumniEngageVideoCommentForm);

//const selector = formValueSelector("alumniEngageVideoCommentForm"); // <-- same as form name

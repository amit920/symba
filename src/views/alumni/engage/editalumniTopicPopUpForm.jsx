...
class editalumniTopicPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      chars_left: 500,
...
editalumniTopicPopUpForm = reduxForm({
  form: "editalumniTopicPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editalumniTopicPopUpForm);
const selector = formValueSelector("editalumniTopicPopUpForm"); // <-- same as form name

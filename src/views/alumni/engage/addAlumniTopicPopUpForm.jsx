...
//   height: "200px",
// };
class addAlumniTopicPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      // userData: []
...
addAlumniTopicPopUpForm = reduxForm({
  form: "addAlumniTopicPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(addAlumniTopicPopUpForm);

const selector = formValueSelector("addAlumniTopicPopUpForm"); // <-- same as form name

...
class editalumniCommentPopUpForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
editalumniCommentPopUpForm = reduxForm({
  form: "editalumniCommentPopUpForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(editalumniCommentPopUpForm);
const selector = formValueSelector("editalumniCommentPopUpForm"); // <-- same as form name

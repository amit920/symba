...
import AlumniSkillsPopupForm from "../profile/alumniSkillsPopupForm";
/* eslint-disable */
...
//   );
// };
class ViewAlumniProfileForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      searchText: null,
        ...
        <Fragment>
          ...
          <Row>
            <Colxx xxs="12" md="12" sm="12" lg="9">
              <NavLink to="/alumniapp/profile/edit">
                <Button
                  outline
                  color="primary"
...
ViewAlumniProfileForm = reduxForm({
  form: "ViewAlumniProfileForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(ViewAlumniProfileForm);
//const selector = formValueSelector("ViewAlumniProfileForm"); // <-- same as form name

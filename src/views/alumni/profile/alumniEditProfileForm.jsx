...
import AlumniSkillsPopupForm from "./alumniSkillsPopupForm";
import AddAlumniProfileImagePopUpForm from "./addAlumniProfileImagePopUpForm";
import AlumniInterestsPopupForm from "./alumniInterestsPopupForm";
/* eslint-disable */
...
class AlumniEditProfileForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      searchText: null,
  ...
  closeProfileImagePopUpModel = () => {
    this.props.dispatch(reset("addAlumniProfileImagePopUpForm"));
  ...
  getResume = () => {
          ...
          <div>
            {
              ...
              >
                ...
                />
                {/* <Link style={{float:'right'}} className='remove-File' onClick={() => { if (window.confirm('Are you sure you want to delete this resource?')) { this.handleRemoveResourcesSubmission(this.props.internDetail.UserId) }; }}> Delete </Link> */}
              </div>
            }
          </div>
        );
    ...
    handleRemoveFile = (userId) => {
      this.props.removeUploadFile(userId);
    };
      ...
      for (let i = 0; i < this.props.internDetail.SocialCount; i++) {
        children.push(
          <Colxx xxs="3" md="2" sm="2" lg="1">
            {
              <div class="profile-pic" style={{ marginBottom: "180px" }}>
                <a
  ...
  closeAddNewSkillsSubmissionModal = () => {
    this.props.dispatch(reset("alumniSkillsPopupForm"));
  ...
  closeAddNewInterestsSubmissionModal = () => {
    this.props.dispatch(reset("alumniInterestsPopupForm"));
        ...
        <form onSubmit={handleSubmit}>
          <Fragment>
            <Row>
              ...
              <Colxx xxs="6" md="6" sm="6">
                <NavLink
                  ...
                  style={{ float: "right" }}
                  to="/alumniapp/profile/reset-password"
                >
                  <Button
                    outline
                    color="primary"
              ...
              <Colxx xxs="12" md="10" lg="6" sm="6">
                ...
                {this.props.internDetail.QuesCount > 0 ? (
                  this.props.internDetail.Question.map((Question, key) => {
                    return (
                      <div>
                        <Accordion className="MuiPaper-elevation1">
                          <AccordionSummary
                            expandIcon={
                  ...
                  <Card className="mb-4">
                    <CardBody>
                      ...
                      <Table>
                        <tbody>
                          <tr>
                            <td className="profile_info_table_heading">Name</td>
                            <th scope="row">
                          ...
                          {/* <tr>
                            ...
                            <th scope="row">
                              <span className="profile_info">
                                {headingPronounsValue}
                              </span>
                            </th>
                          </tr> */}
            {/* <tr>
                            <td className="profile_info_table_heading">Email</td>
                            <th scope="row">
                              <span className="profile_info">
                          ...
                          <tr>
                            ...
                            <th scope="row">
                              <span className="profile_info">
                                {headingExponentialValue}
                              </span>
                            </th>
                          </tr>
                          <tr>
                            <td style={{ fontSize: "15px" }}>{heading}</td>
                            <th scope="row">
                              <span className="profile_info">{headingValue}</span>
                            </th>
                          </tr>
                          <tr>
                            <td style={{ fontSize: "15px" }}>{heading_Role_Classification}</td>
                            <th scope="row">
                              <span className="profile_info">
                          ...
                          <tr>
                            <td style={{ fontSize: "15px" }}>Team</td>
                            <th scope="row">
                              <span className="profile_info">
                                {this.props.currentUser.departmentname}
                              </span>
                ...
                <Colxx xxs="12" md="8" lg="8" sm="8">
                  <Card className="mb-4">
                    <CardBody>
                      ...
                      <span>Share a little more about yourself.</span>
                      <br></br>
                    ...
                    <CardBody>
                      <CardTitle>
                        ...
                        <span style={{ fontSize: "14px" }}>
                          Share more about yourself with links to social or
                          personal sites.
                        </span>
                      </CardTitle>
                  ...
                  <Card className="mb-4">
                    <CardBody>
                      <CardTitle>
                        ...
                        <br></br>
                        <span style={{ fontSize: "14px" }}>
                          Add 5-10 skills so your teammates can find you.
                        </span>
                      </CardTitle>
                      {this.getUserSkills()}
                    </CardBody>
            ...
            {!this.state.showMenu ? (
              <Row>
                <Colxx xxs="12" sm="12" md="12" lg="9">
                  <div style={{ float: "right", marginTop: -86 }}>
                    <Link
                      to="/alumniapp/profile/view"
                      className="button delete-button"
                    >
...
AlumniEditProfileForm = reduxForm({
  form: "AlumniEditProfileForm", // a unique identifier for this form
  validate: (values) => {
    return validate(values, validations);
  },
})(AlumniEditProfileForm);
//const selector = formValueSelector("AlumniEditProfileForm"); // <-- same as form name
